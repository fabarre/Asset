...
const I18N_EN = {
    ...
    'Accesso Deal Simulator': 'Deal Simulator Login',
    'Multi-Plant & BESS Enterprise Platform': 'Multi-Plant & BESS Enterprise Platform',
    'Accedi': 'Sign In',
    'Registrati': 'Sign Up',
    'Recupero': 'Recovery',
    'Registra nuovo utente': 'Register new user',
    'Password dimenticata?': 'Forgot password?',
    'Ricordami su questo browser': 'Remember me on this browser',
    ...
    'Consigliati numeri & simboli': 'Numbers & symbols recommended',
    'Consigliate maiuscole e numeri': 'Uppercase & numbers recommended',
    'Troppo corta (< 6 car.)': 'Too short (< 6 chars)',
    'Debole': 'Weak',
    'Media': 'Medium',
    'Forte': 'Strong',
    'Robustezza': 'Strength',
    'Ripristino Password': 'Password Reset',
    'Invia Link di Ripristino': 'Send Recovery Link',
    'Torna alla schermata di accesso': 'Back to sign in',
    'Imposta Nuova Password': 'Set New Password',
    ...
    'Modifica password account': 'Change account password',
    'Disconnetti (Logout)': 'Sign Out (Logout)',
    'Disconnetti': 'Sign Out',
    'Disconnessione': 'Sign Out',
    'Sei sicuro di voler uscire dal simulatore?': 'Are you sure you want to sign out from the simulator?',
    'Blocco maiuscole (Caps Lock) attivo': 'Caps Lock is on',
    'Ripeti la password': 'Repeat password',
    'Almeno 6 caratteri': 'At least 6 characters',
    'Mostra/Nascondi password': 'Show/Hide password',
    ...
    'Project IRR (Unlevered SPV)': 'Project IRR (Unlevered SPV)',
    'TIR di Progetto (FCFF)': 'Project IRR (FCFF)',
    'Equity IRR (Levered SPV)': 'Equity IRR (Levered SPV)',
    'TIR Azionisti SPV (FCFE)': 'SPV Equity IRR (FCFE)',
    ...
    'LCOE & LCOS Medi': 'Average LCOE & LCOS',
    'LCOE (Solare)': 'LCOE (Solar)',
    'LCOS (Storage)': 'LCOS (Storage)',
    'Costo Livellato FV vs BESS': 'Levelized Cost PV vs BESS',
    'Payback Equity': 'Equity Payback',
    'Levered Payback Period': 'Levered Payback Period',
    'Payback Period (SPV)': 'Payback Period (SPV)',
    'Levered (Equity)': 'Levered (Equity)',
    'Unlevered (Proj)': 'Unlevered (Proj)',
    'Recupero Equity vs Progetto': 'Equity Recovery vs Project Capex',
    'Project Payback (Unlevered SPV)': 'Project Payback (Unlevered SPV)',
    'Recupero Capex Progetto (FCFF)': 'Project Capex Recovery (FCFF)',
    'Equity Payback (Levered SPV)': 'Equity Payback (Levered SPV)',
    'Recupero Equity Soci SPV (FCFE)': 'SPV Equity Recovery (FCFE)',
    'Payback Equity (Levered SPV)': 'Equity Payback (Levered SPV)',
    'Payback Progetto (Unlevered SPV)': 'Project Payback (Unlevered SPV)',
    ...
    'Politica Distribuzione Cassa & Dividendi SPV': 'SPV Cash & Dividend Distribution Policy',
    'FCFE Puro (Cash Flow Driven - Predefinito)': 'Pure FCFE (Cash Flow Driven - Default)',
    'Utile Civilistico Rigido (Art. 2433 c.c. con Riserva Legale 5%)': 'Strict Statutory Profit (Art. 2433 CC with 5% Legal Reserve)',
    'Utile Civilistico + Restituzione Riserve Capitale (Art. 2482 c.c.)': 'Statutory Profit + Capital Reserve Return (Art. 2482 CC)',
    'Impiego Cassa Vincolata SPV (Cash Trap)': 'SPV Locked Cash Deployment (Cash Trap)',
    'Scenari di Impiego': 'Deployment Scenarios',
    'Blocco Conservativo a Garanzia Debito (Nessun Impiego Anticipato)': 'Conservative Lock for Debt Guarantee (No Early Deployment)',
    'Distribuzione su Utili Capienti (Attinge a Cash Trap se Utile > FCFE)': 'Distribution on Retained Profits (Draws from Cash Trap if Profit > FCFE)',
    'Sblocco a Estinzione Debito Senior (Maxi-Dividendo a Debito Zero)': 'Release at Senior Debt Payoff (Zero-Debt Maxi-Dividend)',
    'Rimborso Accelerato Finanziamento Soci (Priorità Estinzione Prestito Soci)': 'Accelerated Shareholder Loan Repayment (Priority Sponsor Debt Payoff)',
    'Prepagamento Debito Senior (Cash Sweep Deleveraging Anticipato)': 'Senior Debt Prepayment (Early Deleveraging Cash Sweep)',
    ...
    'Costo Compensazioni (€)': 'Compensation Cost (€)',
    'Costo Compensazioni': 'Compensation Cost',
    ...
    // ── RID / CER tabs ──
    'RID/CER': 'RID/CER',
    'Configurazione Rete, Ritiro Dedicato (RID) & Comunità Energetiche (CER)': 'Grid, Dedicated Withdrawal (RID) & Renewable Energy Communities (CER) Configuration',
    '1. Rete di Distribuzione & Ritiro Dedicato (RID)': '1. Distribution Grid & Dedicated Withdrawal (RID)',
    '2. Comunità Energetiche Rinnovabili (CER — Quadro MASE & TIAD 2026)': '2. Renewable Energy Communities (CER — MASE & TIAD 2026 Framework)',
    ...
    'Sezione C': 'Section C',
    'Conto Economico Civilistico Holding (HoldCo Level)': 'Holding Statutory Income Statement (HoldCo Level)',
    'Sezione D': 'Section D',
    ...
    // ── P&L row labels (dynamic, Sez. A/B/C/D) ──
    ...
    '  (-) Accantonamento Riserva Legale SPV (5% ex Art. 2430 c.c.) (€)': '  (-) SPV Legal Reserve Accrual (5% ex Art. 2430 CC) (€)',
    '  Capacità Distributiva Utili SPV Cumulata (€)': '  Cumulative SPV Distributable Profits Capacity (€)',
    '  (-) Interessi Soci Pagati da SPV a HoldCo (-> Sez. C) (€)': '  (-) Shareholder Loan Interest paid to HoldCo (-> Sec. C) (€)',
    '  (-) Rimborso Capitale Finanziamento Soci a HoldCo (-> Sez. D) (€)': '  (-) Shareholder Loan Principal Repayment to HoldCo (-> Sec. D) (€)',
    '  (-) Dividendi SPV Distribuiti a HoldCo (da Utili Art. 2433 c.c.) (-> Sez. C) (€)': '  (-) SPV Dividends Distributed to HoldCo (from Profits Art. 2433 CC) (-> Sec. C) (€)',
    '  (-) Restituzione Riserve di Capitale / Esuberanza a HoldCo (Art. 2482 c.c.) (-> Sez. D) (€)': '  (-) Return of Capital Reserves / Excess to HoldCo (Art. 2482 CC) (-> Sec. D) (€)',
    '(=) Cassa Rimanente non distribuita in SPV (Cash Trap) (€)': '(=) Undistributed Cash retained in SPV (Cash Trap) (€)',
    '1. CONTO ECONOMICO CIVILISTICO HOLDING (PROVENTI ED ONERI D\'ESERCIZIO)': '1. HOLDING STATUTORY INCOME STATEMENT (REVENUES & EXPENSES)',
    '  (+) Proventi da Partecipazioni: Dividendi SPV da Utili (Art. 2433 c.c.) (€)': '  (+) Income from Investments: SPV Dividends from Profits (Art. 2433 CC) (€)',
    '  (+) Proventi Finanziari: Interessi Attivi Finanziamento Soci SPV (€)': '  (+) Financial Income: Shareholder Loan Interest from SPV (€)',
    '  (+) Ricavi per Servizi: Gestione Amministrativa & Asset Management a SPV (€)': '  (+) Service Revenues: Asset Management & Administration to SPV (€)',
    '(=) TOTALE RICAVI E PROVENTI HOLDING (€)': '(=) TOTAL HOLDING REVENUES & INCOME (€)',
    '  (-) Spese Generali e Costi di Funzionamento Holding (OPEX) (€)': '  (-) General & Operating Expenses HoldCo (OPEX) (€)',
    '  (-) Oneri Diversi di Gestione: Quota Earn-Out Holding (€)': '  (-) Other Operating Charges: HoldCo Earn-Out (€)',
    '(=) RISULTATO OPERATIVO HOLDING (EBIT HOLDCO) (€)': '(=) HOLDING OPERATING PROFIT (HOLDCO EBIT) (€)',
    '  (-) Oneri Finanziari: Interessi Passivi Private Debt Holding (€)': '  (-) Financial Charges: HoldCo Private Debt Interest (€)',
    '(=) RISULTATO ANTE IMPOSTE (EBT HOLDCO) (€)': '(=) PROFIT BEFORE TAX (HOLDCO EBT) (€)',
    '(=) UTILE NETTO CIVILISTICO HOLDING (€)': '(=) HOLDING STATUTORY NET PROFIT (€)',
    '2. RENDICONTO FINANZIARIO & FLUSSO NETTO INVESTITORE (FCFE HOLDCO)': '2. CASH FLOW STATEMENT & INVESTOR NET CASH FLOW (HOLDCO FCFE)',
    '-> Utile Netto Civilistico Holding (da Sezione C sopra) (€)': '-> Holding Statutory Net Profit (from Section C above) (€)',
    '-> Utile Netto Civilistico Holding (da Conto Economico sopra) (€)': '-> Holding Statutory Net Profit (from Income Statement above) (€)',
    '  (+) Incassi Patrimoniali: Rimborso Capitale Finanziamento Soci da SPV (€)': '  (+) Equity Inflows: Shareholder Loan Principal Repayment from SPV (€)',
    '  (+) Incassi Patrimoniali: Restituzione Riserve di Capitale SPV (Art. 2482 c.c.) (€)': '  (+) Equity Inflows: Return of Capital Reserves from SPV (Art. 2482 CC) (€)',
    '(=) CASSA GENERATA DALLA GESTIONE ORDINARIA HOLDING (€)': '(=) CASH GENERATED FROM HOLDING ORDINARY OPERATIONS (€)',
    '  (-) Quota Capitale Private Debt Holding (Ammortamento) (€)': '  (-) Private Debt Principal Repayment (Amortization) (€)',
    '(=) FCFE - FLUSSO NETTO INVESTITORE (SPONSOR) (€)': '(=) FCFE - INVESTOR NET CASH FLOW (SPONSOR) (€)',
    '3. RIEPILOGO QUADRATURA FLUSSI TRASFERITI DA SPV A HOLDING': '3. SUMMARY RECONCILIATION OF TRANSFERRED CASH FLOWS SPV TO HOLDING',
    'RIEPILOGO QUADRATURA FLUSSI TRASFERITI DA SPV A HOLDING': 'SUMMARY RECONCILIATION OF TRANSFERRED CASH FLOWS SPV TO HOLDING',
    '(=) Totale Liquidità Effettiva Trasferita da SPV a Holding nel Periodo (€)': '(=) Total Actual Liquidity Transferred from SPV to Holding in Period (€)',
    '  di cui: Dividendi SPV da utili ricevuti (quota Sponsor) (€)': '  of which: SPV Dividends from profits received (Sponsor share) (€)',
    '  di cui: Restituzione Riserve di Capitale / Esuberanza SPV (Art. 2482 c.c.) (€)': '  of which: Return of Capital Reserves / Excess from SPV (Art. 2482 CC) (€)',
    'UTILE NETTO HOLDING CIVILISTICO (€)': 'HOLDING STATUTORY NET PROFIT (€)',
    '  (+) Restituzione Riserve di Capitale / Esuberanza SPV (Cassa Patrimoniale) (€)': '  (+) Return of Capital Reserves / Excess from SPV (Equity Cash Flow) (€)',
    ...
    'Gestione utenti (solo amministratori)': 'User management (admin only)',
